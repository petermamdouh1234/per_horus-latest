  ...
  const Index = () => {
    ...
    <p className="text-lg mb-6">
      ...
      <span className="text-pharaonic-gold text-2xl"> ☥</span> Nous venons rappeler qu’il est encore là — intact —
      mais que l’intelligence  <br /> pour l’accueillir s’est effondrée.
  ...
  <ScrollReveal delay={400}>
    <p className="text-lg mb-8">
      ...
      <br />
      <br />
      <span className="text-pharaonic-gold text-2xl"> ☥</span> Ici, nous bâtissons des pyramides 
      En nous.<br />
    ...
    comme dans l’Égypte des bâtisseurs, seul système vivant à avoir traversé les millénaires sans s'effondrer.
        ...
        {/* Video Section */}
        <div className="py-16 bg-pharaonic-charcoal/5">
          <div className="container mx-auto px-4">
            <ScrollReveal>
              <div className="max-w-4xl mx-auto">
                <h2 className="pharaonic-heading text-2xl md:text-3xl text-center mb-8">
                ...
                <div className="text-center mt-6">
                  <p className="text-lg font-egyptian text-pharaonic-gold">
        ...
        {/* CTA Section */}
        <div className="py-16 bg-pharaonic-charcoal text-white relative overflow-hidden">
            ...
            <ScrollReveal>
              <div className="max-w-3xl mx-auto text-center">
                <div className="flex justify-center mb-6">
                  <span className="text-pharaonic-gold text-4xl"> <span className="text-pharaonic-gold">☥</span></span>
                </div>
    ...
    <span className="text-pharaonic-gold text-2xl"> ☥</span> Ici, tout est acte<br />
      ...
      <span className="text-pharaonic-gold text-2xl"> ☥</span> La bibliomancie vivante, où chaque page devient un signal — et vous répond.<br />
      <br />
      <span className="text-pharaonic-gold text-2xl">✦</span> Rien à consommer. Tout à traverser<span className="text-pharaonic-gold text-2xl"> ✦</span><br />
      <br />
      
      <span className="text-pharaonic-gold text-2xl">✦</span> Pour qui ?<br />
      
      <span className="text-pharaonic-gold text-2xl">𓆓</span> Pour ceux que la modernité vide,
      et que la spiritualité sucrée endort.<br />
      <span className="text-pharaonic-gold text-2xl">𓆓</span> Pour les cerveaux qui tournent vite —
      pas par défaut, mais par dessein divin.<br />
      ...
      <span className="text-pharaonic-gold text-2xl">𓆓</span> Ceux qui ne cherchent plus, mais construisent de l’intérieur.<br />
    ...
    <div className="flex flex-col items-center justify-center mt-12 gap-4">
      <div className="flex flex-col md:flex-row gap-4 w-full md:justify-center">
        <Link 
        to="/about"
          className="w-full md:w-[250px] text-center px-2 py-1 bg-pharaonic-gold text-pharaonic-charcoal font-medium rounded
